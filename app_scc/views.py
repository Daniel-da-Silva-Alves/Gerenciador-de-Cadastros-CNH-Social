...
from app_scc.forms import Registros_CNH_Form, Registros_JM_Form, Registros_CRT_Form, Registros_CEDV_Form, Inscricao_Candidatos_Form, Correcao_CNH_Form, Correcao_CRT_Form, Correcao_CEDV_Form, Correcao_JM_Form
from app_scc.models import Candidatos 
